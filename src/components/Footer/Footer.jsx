  ...
  return (
    <footer className="bg-white border-t border-slate-200 mt-10">
      <div className="container py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          <Link href='/' className="logo">Prodexa</Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-slate-600 text-sm">
            ...
            <li><Link href="/dashboard/add-product" className="hover:text-purple-600">Add Product</Link></li>
            <li><Link href="/dashboard/manage" className="hover:text-purple-600">Manage Products</Link></li>
          </ul>
        </div>
        {/* Support */}
        <div>
      ...
      <div className="border-t border-slate-200 py-4 text-center text-sm text-slate-500">
        © {new Date().getFullYear()} Prodexa. All rights reserved.
      </div>
    </footer>
  )
}
