      ...
      <div className="container py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-slate-600 text-sm">
            ...
            <li><Link href="/add-product" className="hover:text-purple-600">Add Product</Link></li>
            <li><Link href="/manage-products" className="hover:text-purple-600">Manage Products</Link></li>
          </ul>
        </div>
